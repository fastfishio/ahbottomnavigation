...
public class DemoActivity extends AppCompatActivity {
	...
	private void initUI() {
		...
		if (useMenuResource) {
			...
			AHBottomNavigationItem item1 = new AHBottomNavigationItem(R.string.tab_1, R.drawable.ic_apps_black_24dp, R.color.color_tab_1, 0, false, 0);
			AHBottomNavigationItem item2 = new AHBottomNavigationItem(R.string.tab_2, R.drawable.ic_maps_local_bar, R.color.color_tab_2, 0, false, 0);
			AHBottomNavigationItem item3 = new AHBottomNavigationItem(R.string.tab_3, R.drawable.ic_maps_local_restaurant, R.color.color_tab_3, 0, false, 0);
		...
		if (useMenuResource) {
			...
			if (addItems) {
				AHBottomNavigationItem item4 = new AHBottomNavigationItem(getString(R.string.tab_4),
						...
						ContextCompat.getColor(this, R.color.color_tab_4), null, false, 0);
				AHBottomNavigationItem item5 = new AHBottomNavigationItem(getString(R.string.tab_5),
						...
						ContextCompat.getColor(this, R.color.color_tab_5), null, false, 0);
